...
RJ가 만들어지기 이전에는 전화기를 연결하기 위해서는 비싸고 복잡한 연결 방법을 거쳐야 했다. 이를 개선하기 위해 미국 연방통신 위원회(FCC: Federal Communicaitons Commission) 에서는 Bell System(Bell Telephone Company)에게 표준화된 전화기 연결을 손쉽게 연결할 수 있는 방법을 모색해 내도록 지시하였다.  
